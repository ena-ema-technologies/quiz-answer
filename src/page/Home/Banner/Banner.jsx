...
const Banner = () => {
    ...
    const testIncreased = () => {
        ...
        fetch(`http://localhost:5000/number-increase?increaseNumber=${testCount}`, {
            method: "PATCH",
        ...
        <div  >
            <div className="z-10">
                <div className="w-full bg-[#4298B4] py-10">
                    ...
                    <div className="flex justify-center mt-10">
                        <button className='btn bg-[#33a474] border-[#33a474] flex items-center gap-3' onClick={testIncreased}> Eats Quiz <FaArrowRight /> </button>
                    </div>
                </div>
            ...
            <div className='max-w-[1440px] mx-auto'>
                <div className=' text-center mt-10 ' >
                    <h1 className='text-4xl md:text-6xl font-medium  text-[#33A474]'>{testCount}</h1>
